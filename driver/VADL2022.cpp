...
VADL2022::VADL2022(int argc, char** argv)
{
  ...
  if (videoCapture) {
    ...
    //pyRunFile("driver/fore.py", sizeof(LIS331HH_videoCapArgs) / sizeof(LIS331HH_videoCapArgs[0]), (char **)LIS331HH_videoCapArgs);
    pyRunFile("driver/strainLogger.py", 0, '');
